        ...
        return httpSecurity
                ...
                .cors(corsCustomizer -> corsCustomizer.configurationSource(new CorsConfigurationSource() {
                    ...
                    public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
                        ...
                        configuration.setAllowedOrigins(Arrays.asList(serverConfig.getBack(), serverConfig.getFront(), "http://localhost:3000", "https://openapi.map.naver.com", "https://openapi.map.naver.com/openapi/v3/maps.js"));
