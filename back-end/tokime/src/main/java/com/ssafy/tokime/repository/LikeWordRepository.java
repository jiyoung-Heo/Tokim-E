...
public interface LikeWordRepository extends JpaRepository<Likeword, Long> {
    ...
    @Query("SELECT l FROM Likeword l WHERE l.userId = :userId AND l.termId = :termId")
    List<Likeword> findAllByUserIdOrderByTermId(@Param("userId") Long userId, @Param("termId") Long termId);
